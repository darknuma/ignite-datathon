import random
import pandas as pd
from generate_db import students, student_classes
...
def generate_student_more_info(students):
    student_more_info = []
    ...
    for student in students:
        ...
        subject_struggle = random.choice(
...
student_more_info = generate_student_more_info(students)
